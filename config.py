...
terminal = "kitty"
browser = "brave"
wallpaper = "feh --randomize --bg-fill '/home/abirkmand/Pictures/wallpapers'"
...
def startup():
    subprocess.call('/home/abirkmand/.config/qtile/autostart.sh')
...
keys = [
    ...
    #wallpapers
     Key([mod], "g", lazy.spawn(wallpapers)),
    
    # Edit config    
    Key([mod], "e", lazy.spawn('kitty -e nvim /home/abirkmand/.config/qtile/config.py'), desc="Edit config"),
